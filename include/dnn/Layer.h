...
public:
    InputLayer(size_t feature_dim){
        _input_dim = feature_dim;
        _output_dim = feature_dim;
        _type = INPUT;
    }
...
public:
    FullConnLayer(const size_t input_dim,
                  ...
                  const real& stddev = 1.0f){
        _input_dim      = input_dim;
        _output_dim     = output_dim;
        _type           = FULL_CONNECTION;
