...
public:
	...
	void read_word2index(const std::string& data_file, std::map<std::string, size_t> dict);
...
void RNNHelper::read_word2index(const std::string& data_file, std::map<std::string, size_t> dict){
