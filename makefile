...
all:
	...
	${CC} -o cnn_mnist -std=c++11 example/cnn.cpp src/cnn/Layer.cpp src/cnn/CNN.cpp src/framework/Pool.cpp src/algebra/MatrixBase.cpp src/algebra/MatrixOperator.cpp src/algebra/MatrixAlgebra.cpp src/algebra/MatrixHelper.cpp src/utils/Log.cpp -g -pthread -I include/ -Wall
