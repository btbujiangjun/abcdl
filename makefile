...
#	${CC} -o cnn_test -std=c++11 example/cnn.cpp src/cnn/Layer.cpp src/cnn/CNN.cpp src/framework/Pool.cpp src/algebra/MatrixBase.cpp src/algebra/MatrixOperator.cpp src/algebra/MatrixAlgebra.cpp src/algebra/MatrixHelper.cpp src/utils/Log.cpp -g -pthread -I include/ -Wall
	${CC} -o rnn_test -std=c++11 example/rnn.cpp src/rnn/Layer.cpp src/rnn/RNN.cpp src/algebra/MatrixBase.cpp src/algebra/MatrixOperator.cpp src/algebra/MatrixAlgebra.cpp src/algebra/MatrixHelper.cpp src/utils/Log.cpp -g -pthread -I include/ -Wall
clean:
	rm -rf matrix_test* &
	rm -rf dnn_test* &
	rm -rf cnn_test* &
